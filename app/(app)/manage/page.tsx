  ...
  return (
    <TabPage title="Manage">
      ...
      {featureEnabled("lessons") && (
        ...
        >
          <span className="flex-1">
            <span className="block text-base font-semibold">Weekly schedule</span>
            <span className="block text-sm text-brand-ink/60">
              The repeating lesson pattern.
            </span>
          </span>
          <span aria-hidden="true" className="text-brand-ink/40">
            ›
      ...
      {featureEnabled("horses") && (
        ...
        >
          <span className="flex-1">
            <span className="block text-base font-semibold">Horses</span>
            <span className="block text-sm text-brand-ink/60">
              Records, who rides what, and feed charts.
            </span>
          </span>
          <span aria-hidden="true" className="text-brand-ink/40">
            ›
      ...
      {featureEnabled("care") && (
        ...
        >
          <span className="flex-1">
            <span className="block text-base font-semibold">Care due</span>
            <span className="block text-sm text-brand-ink/60">
              Vaccines, Coggins, worming and farrier dates coming up.
            </span>
          </span>
          <span aria-hidden="true" className="text-brand-ink/40">
            ›
      ...
      {featureEnabled("forms") && (
        ...
        >
          <span className="flex-1">
            ...
            <span className="block text-sm text-brand-ink/60">
              Who has signed their paperwork, and who hasn&apos;t.
            </span>
          </span>
          <span aria-hidden="true" className="text-brand-ink/40">
            ›
      ...
      {featureEnabled("events") && (
        <Link
          href="/manage/events"
          className="flex min-h-16 items-center gap-3 rounded-2xl border border-brand-ink/10 bg-white p-4"
        >
          <span className="flex-1">
            <span className="block text-base font-semibold">Calendar</span>
            <span className="block text-sm text-brand-ink/60">
              Shows, clinics, farrier and vet days, closures.
            </span>
          </span>
          <span aria-hidden="true" className="text-brand-ink/40">
            ›
